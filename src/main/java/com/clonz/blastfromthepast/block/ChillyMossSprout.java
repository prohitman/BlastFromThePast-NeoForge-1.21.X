...
public class ChillyMossSprout extends BushBlock implements IShearable, BonemealableBlock {
    ...
    protected void randomTick(BlockState state, ServerLevel level, BlockPos pos, RandomSource random) {
        ...
        boolean canGrow = level.getRawBrightness(pos.above(), 0) >= 9 && CommonHooks.canCropGrow(level, pos, state, true);
        if (canGrow) {
            if (i < 1) {
                ...
                BlockState state1 = ModBlocks.CHILLY_MOSS_SPROUT.get().defaultBlockState();
    ...
    public void performBonemeal(ServerLevel level, RandomSource random, BlockPos pos, BlockState state) {
        ...
        if(i==0){
            ...
            BlockState state1 = ModBlocks.CHILLY_MOSS.get().defaultBlockState();
