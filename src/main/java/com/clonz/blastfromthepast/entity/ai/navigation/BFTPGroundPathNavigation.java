...
/**
 * Credit: <a href="https://github.com/BobMowzie/MowziesMobs/blob/master/src/main/java/com/bobmowzie/mowziesmobs/server/ai/MMPathNavigateGround.java">Mowzie's Mobs</a>
 */
public class BFTPGroundPathNavigation extends GroundPathNavigation {
    ...
    protected PathFinder createPathFinder(int maxVisitedNodes) {
        ...
        this.nodeEvaluator = customNodeEvaluator;
